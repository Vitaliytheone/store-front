...
use common\models\sommerce\queries\PagesOldQuery;
 ...
 */
class PagesOld extends ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return PagesOldQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new PagesOldQuery(get_called_class());
    }
