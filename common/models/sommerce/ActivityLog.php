...
use common\models\sommerce\queries\ActivityLogQuery;
...
class ActivityLog extends ActiveRecord
{
    ...
    const E_SETTINGS_GENERAL_STORE_CURRENCY_CHANGED = 2006;

    const E_SETTINGS_PAYMENTS_PG_ACTIVE_STATUS_CHANGED = 2101;
    const E_SETTINGS_PAYMENTS_PG_SETTINGS_CHANGED = 2102;
    const E_SETTINGS_PAYMENTS_SPM_ITEM_POSITION_CHANGED = 2103;
    const E_SETTINGS_PAYMENTS_SPM_CURRENCY_DELETED = 2104;
