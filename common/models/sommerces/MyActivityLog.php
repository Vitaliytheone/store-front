...
class MyActivityLog extends ActiveRecord
{
    ...
    {
        return DB_SOMMERCES . '.my_activity_log';
    }
    ...
    /**
     * @inheritdoc
     * @return \common\models\sommerces\queries\MyActivityLogQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\sommerces\queries\MyActivityLogQuery(get_called_class());
    }
