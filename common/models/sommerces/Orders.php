...
use control_panel\components\behaviors\IpBehavior;
...
class Orders extends ActiveRecord
{
    ...
    const ITEM_PROLONGATION_SSL = 4;
    const ITEM_PROLONGATION_DOMAIN = 5;
    const ITEM_BUY_TRIAL_STORE = 6;
    const ITEM_FREE_SSL = 7;
    const ITEM_PROLONGATION_FREE_SSL = 8;
    ...
    public function rules()
    {
        return [
            ...
            [['item'], 'default', 'value' => static::ITEM_BUY_STORE],
            [['details'], 'safe'],
        ];
    }
