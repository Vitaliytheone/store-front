...
use control_panel\components\behaviors\TicketFilesBehavior;
use Yii;
use common\models\sommerces\queries\TicketMessagesQuery;
use yii\db\ActiveRecord;
use control_panel\components\behaviors\IpBehavior;
use control_panel\components\behaviors\UserAgentBehavior;
...
class TicketMessages extends ActiveRecord
{
    ...
    {
        return DB_SOMMERCES . '.ticket_messages';
    }
