 ...
 */
class m180322_151113_store_n_database_collation_conversions extends Migration
{
    /**
     * {@inheritdoc}
     */
        ...
        foreach ($store_db as $db) {
            ...
            if ($isDbExist) {
                ...
                $this->execute("
                    ...
                    ALTER TABLE `blocks` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `carts` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `checkouts` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `custom_themes` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `files` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `navigation` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `orders` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `packages` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `pages` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `payments` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `payments_log` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `products` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                    ALTER TABLE `suborders` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
                ");
            } else {
