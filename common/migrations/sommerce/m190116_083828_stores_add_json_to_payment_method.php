...
/**
 * Class m190116_083828_stores_add_json_to_payment_method
 */
class m190116_083828_stores_add_json_to_payment_method extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->execute('
            ...
            SET `settings_form` = \'{\"merchant_id\":{\"code\":\"merchant_id\",\"name\":\"merchant_id\",\"type\":\"input\",\"label\":\"settings.payments_free_kassa_merchant_id\"},\"secret_word\":{\"code\":\"secret_word\",\"name\":\"secret_word\",\"type\":\"input\",\"label\":\"settings.payments_free_kassa_secret_word\"},\"secret_word2\":{\"code\":\"secret_word2\",\"name\":\"secret_word2\",\"type\":\"input\",\"label\":\"settings.payments_free_kassa_secret_word2\"}}\',
                `settings_form_description` = \'<ul>\r\n<li> Go to the Free Kassa settings page </li>\r\n<li> Select the notification method <code>POST</code> </li>\r\n<li> Select the integration mode <code>NO</code></li>\r\n<li> Site URL: <code>{store_site}/</code> </li>\r\n<li> Notification URL: <code>{store_site}/freekassa</code></li>\r\n<li> Success URL: <code>{store_site}/cart</code></li>\r\n<li> Unsuccess URL: <code>{store_site}/cart</code></i>\r\n</ul>\',
            ...
            SET `settings_form` = \'{\"merchant_id\":{\"code\":\"merchant_id\",\"name\":\"merchant_id\",\"type\":\"input\",\"label\":\"settings.payments_paytr_merchant_id\"},\"merchant_key\":{\"code\":\"merchant_key\",\"name\":\"merchant_key\",\"type\":\"input\",\"label\":\"settings.payments_paytr_merchant_key\"},\"merchant_salt\":{\"code\":\"merchant_salt\",\"name\":\"merchant_salt\",\"type\":\"input\",\"label\":\"settings.payments_paytr_merchant_salt\"},\"commission\":{\"code\":\"commission\",\"name\":\"commission\",\"type\":\"input\",\"label\":\"settings.payments_paytr_merchant_comission\"}}\',
                `settings_form_description` = \'<ul>\r\n<li>Go to Merchant Settings</li>\r\n<li>Set callback url: <code>{store_site}/paytr</code></li>\r\n</ul>\',
            ...
            SET `settings_form` = \'{\"apiKey\":{\"code\":\"apiKey\",\"name\":\"apiKey\",\"type\":\"input\",\"label\":\"settings.payments_paywant_apiKey\"},\"apiSecret\":{\"code\":\"apiSecret\",\"name\":\"apiSecret\",\"type\":\"input\",\"label\":\"settings.payments_paywant_apiSecret\"},\"fee\":{\"code\":\"fee\",\"name\":\"fee\",\"type\":\"input\",\"label\":\"settings.payments_paywant_fee\"}}\',
                `settings_form_description` = \'<ul>\r\n<li>Go to Merchant Settings</li>\r\n<li>Store Site: <code>{store_site}</code></li>\r\n<li>IP address (Site): <code>54.36.105.233</code></li>\r\n<li>API IPN: <code>{store_site}/paywant</code></li>\r\n</ul>\',
            ...
            SET `settings_form` = \'{\"collectionId\":{\"code\":\"collectionId\",\"name\":\"collectionId\",\"type\":\"input\",\"label\":\"settings.payments_billplz_collectionId\"},\"secret\":{\"code\":\"secret\",\"name\":\"secret\",\"type\":\"input\",\"label\":\"settings.payments_billplz_secret\"}}\',
                `settings_form_description` = \'<ul>\r\n<li>Go to Merchant Settings</li>\r\n<li>Status URL: <code>{store_site}/billplz</code></li>\r\n<li>Success URL: <code>{store_site}/addfunds</code></li>\r\n<li>Fail URL: <code>{store_site}/addfunds</code></li>\r\n</ul>\',
            ...
            UPDATE `payment_methods`
            SET `settings_form` = \'{\"public_key\":{\"code\":\"public_key\",\"name\":\"public_key\",\"type\":\"input\",\"label\":\"settings.payments_stripe_public_key\"},\"secret_key\":{\"code\":\"secret_key\",\"name\":\"secret_key\",\"type\":\"input\",\"label\":\"settings.payments_stripe_secret_key\"},\"webhook_secret\":{\"code\":\"webhook_secret\",\"name\":\"webhook_secret\",\"type\":\"input\",\"label\":\"settings.payments_stripe_webhook_secret\"}}\',
                `settings_form_description` = \'<ol>\r\n<li>Publishable key and Secret key you may find on <a href=\"https://dashboard.stripe.com/account/apikeys\" target=\"_blank\">https://dashboard.stripe.com/account/apikeys</a></li>\r\n<li>Go to <a href=\"https://dashboard.stripe.com/account/webhooks\" target=\"_blank\">https://dashboard.stripe.com/account/webhooks</a> and add endpoint for <code>{store_site}/stripe_3d_secure</code></li>\r\n<li>Click on created webhook to get Signing secret</li>\r\n</ol>\',
                `addfunds_form` = \'{\"token\":{\"name\":\"token\",\"type\":\"hidden\"},\"email\":{\"name\":\"email\",\"type\":\"hidden\"}}\',
                `icon` = \'/img/pg/stripe_logo.png\'
    ...
    public function safeDown()
    {
        $this->execute('
            ...
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'paypal\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'2checkout\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'coinpayments\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'pagseguro\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'webmoney\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'yandexmoney\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'freekassa\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'paytr\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'paywant\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'billplz\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'authorize\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'yandexcards\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'stripe\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'mercadopago\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'paypalstandard\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'mollie\';
            UPDATE `payment_methods` SET `settings_form` = \'\', `settings_form_description` = \'\', `icon` = \'\' WHERE `payment_methods`.`method_name` = \'stripe_3d_secure\';
        ');
    }
