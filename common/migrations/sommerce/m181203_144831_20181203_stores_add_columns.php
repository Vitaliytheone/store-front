...
class m181203_144831_20181203_stores_add_columns extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addColumn(DB_STORES . '.stores', 'dns_checked_at', $this->text()->defaultValue(null)->comment('Last dns-check timestamp'));
        $this->addColumn(DB_STORES . '.stores', 'dns_status', $this->text()->defaultValue(null)->comment('dns-check result: null-неизвестно, 0-не наши ns, 1-наш ns'));
    }
