<?php
namespace my\components\mailer\mailgun;

use Yii;
use yii\mail\BaseMessage;
use Mailgun\Messages\MessageBuilder;

//require_once Yii::getAlias('@vendor') .'/mailgun/mailgun-php/src/Mailgun/Constants/Constants.php';
...
class Message extends BaseMessage
{
    ...
    /**
     * @return MessageBuilder Swift message instance.
     */
