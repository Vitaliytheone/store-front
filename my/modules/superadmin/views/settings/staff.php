    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group list-group__custom">
                ...
                <a href="<?=Url::toRoute('/settings/staff')?>" class="list-group-item list-group-item-action active"><span class="fa fa-user-o"></span> <?=Yii::t('app/superadmin', 'pages.settings.menu_staff')?></a>
