    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'child_panels.order.registrant_modal_header')?></h4>
            </div>
                <div class="form-horizontal">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><?= Yii::t('app', 'child_panels.order.registrant_modal_btn_close') ?></button>
                        <button type="submit" class="btn btn-primary has-spinner" id="orderDomainBtn" data-action="<?= Url::toRoute('childpanels/order-domain') ?>">
                            <span class="spinner"><i class="fa fa-spinner fa-spin"></i></span>
                            <?= Yii::t('app', 'child_panels.order.registrant_modal_btn_submit') ?>
                        </button>
                    </div>
