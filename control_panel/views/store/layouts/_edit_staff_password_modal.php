<?php
    ...
    /* @var $model control_panel\models\forms\SetStoreStaffPasswordForm */

    use control_panel\components\ActiveForm;
    use yii\bootstrap\Html;
    use control_panel\models\forms\SetStoreStaffPasswordForm;
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'stores.edit_staff_password.header')?></h4>
            </div>
            <?php $form = ActiveForm::begin([
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?= Yii::t('app', 'stores.edit_staff_password.modal_cancel') ?></button>

                    <?= Html::submitButton(Yii::t('app', 'stores.edit_staff_password.modal_submit'), [
