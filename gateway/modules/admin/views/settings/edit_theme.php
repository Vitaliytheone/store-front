                        ...
                        <div class="col-12">
                            ...
                            <form id="edit_theme_form" name="ThemeForm" method="post" action="<?= Url::toRoute(['/settings/update-theme', 'theme' => $theme->folder, 'file' => $currentFile]) ?>">
                                ...
                                <div class="m-portlet gateway-settings__editor">
                                    ...
                                    <div class="row gateway-editorPage <?= $currentFile ? '' : 'align-items-center' ?> ">

                                        <div class="col-lg-10 gateway-editorPage__text order-2 order-lg-1 <?= $currentFile ? '' : 'text-center' ?> ">
                                            <?php if ($currentFile): ?>
