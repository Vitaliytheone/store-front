...
use store\modules\admin\models\forms\LoginForm;
use store\modules\admin\models\forms\SuperLoginForm;
use Yii;
...
class SiteController extends AdminController
{
    ...
    public function actions()
    {
        return [
            'error' => [
                'class' => 'store\modules\admin\components\CustomErrorAction',
