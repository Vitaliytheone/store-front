...
;(function ($) {
    $.fn.rating = function (callback) {
        ...
        this.each(function (i, v) {
            ...
            $(v).data('rating', { callback: callback }).bind('init.rating', $.fn.rating.init).bind('set.rating', $.fn.rating.set).bind('hover.rating', $.fn.rating.hover).trigger('init.rating');
        });
    };
        ...
        set: function set(e, val) {
            ...
            if (val) {
                ...
                input = item.filter(function (i) {
                    if ($(this).attr('title') == val) return $(this);else return false;
                });
        ...
        click: function click(e) {
            ...
            var el = $(e.target),
                ...
                matchInput = inputs.filter(function (i) {
                    if ($(this).val() == rate) return true;else return false;
                });
