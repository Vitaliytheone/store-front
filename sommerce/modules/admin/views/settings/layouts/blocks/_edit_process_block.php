...
<div class="container">
    ...
    <div class="row editor-block border border-grey align-items-center m-portlet m-portlet--mobile">
        ...
        <div class="col-md-8 text-md-right">
            ...
            <div class="editor-block__setting-block flex-wrap">
                <div class="editor-block__setting-title">Steps</div>
                <div class="editor-block__setting-action d-flex flex-wrap align-items-center">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-secondary">
                                <input type="radio" name="process-count" class="process-count" value="4" autocomplete="off"> 3
                            </label>
                            <label class="btn btn-secondary">
                                <input type="radio" name="process-count" class="process-count" value="3" autocomplete="off"> 4
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12">
            <div class="editor-block__title-h1">
                <div class="editor-textarea__text-edit-off">
                    <textarea class="editor-textarea__h editor-textarea__h2 js-auto-size process-title" data-textarea-title="header-title" rows="1" spellcheck="false" placeholder="Add title..."></textarea>
            ...
            <div class="editor-block__description">
                <div class="editor_textarea-block">
                    <div class="editor-textarea__text-edit-off">
                        <textarea class="editor_textarea__text js-auto-size text-center process-description" data-textarea-title="header-description" rows="1" spellcheck="false" placeholder="Add text..."></textarea>
                        <div class="editor-textarea__text-edit-action">
                            <button class="btn btn-sm btn-success cursor-pointer editor-textarea__text-edit-save">Save</button>
                            <button class="btn btn-sm btn-secondary cursor-pointer editor-textarea__text-edit-close">Close</button>
                        </div>
    ...
    <div class="row editor-block border border-grey editor-block__steps m-portlet m-portlet--mobile">

        <ul class="row block-editor-list" id="process-list"></ul>
