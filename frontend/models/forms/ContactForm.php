...
class ContactForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['recaptcha', 'required', 'message' => 'Please check the reCAPTCHA box!'],
     ...
     * @return bool
     */
    public function contact($postData)
    {
        ...
        $this->setAttributes([
            'recaptcha' =>  ArrayHelper::getValue($postData, 'g-recaptcha-response')
        ]);
        ...
        $text = $this->name . PHP_EOL . $this->email . PHP_EOL . $this->subject . PHP_EOL . $this->message . PHP_EOL;
