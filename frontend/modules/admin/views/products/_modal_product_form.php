    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header"
                 data-title_create="<?= \Yii::t('admin', 'products.product_title_create') ?>"
                 data-title_edit="<?= \Yii::t('admin', 'products.product_title_edit') ?>"
            >
            ...
            <form id="productForm" class="form-horizontal" action="/" method="post" role="form" data-success_redirect="<?= Url::to(['/admin/products'])?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form_field__url form-control" id="edit-seo__url" name="ProductForm[url]"
                                               value="<?= \Yii::t('admin', 'products.product_seo_url_default') ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer justify-content-start">
                    <button type="submit" id="submitProductForm" class="btn btn-primary"
                            data-title_create="<?= \Yii::t('admin', 'products.product_save_title_create') ?>"
                            data-title_save="<?= \Yii::t('admin', 'products.product_save_title_save') ?>"
                    >
                        Add product
                    </button>
