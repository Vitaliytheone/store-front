...
<tr>
    <td class="sommerce-table__no-wrap"><?= Html::encode($page['name']) ?></td>
    ...
    <td class="sommerce-table__no-wrap text-lg-right">
        <a class="btn m-btn--pill m-btn--air btn-sm btn-primary" href="<?= Url::toRoute(['/settings/edit-page', 'id' => $page['id']]) ?>">
