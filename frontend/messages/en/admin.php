...
return [
    ...
    'payments.payment_method_coinpayments' => 'Coin Payments',
    ...
    'settings.payments_coinpayments_guide_1' => 'Sign up at {signup_url}.',
    'settings.payments_coinpayments_guide_2' => 'Configure accepted currency on {coin_settings_url} page.',
    'settings.payments_coinpayments_guide_3' => 'Configure your merchant settings on {account_settings_url} page:',
    'settings.payments_coinpayments_guide_3_2' => 'Remember your Merchant ID from the "Basic Settings" tab section',
    'settings.payments_coinpayments_guide_3_1' => 'Fill the IPN Secret field in the "Merchant Settings" tab section',
    'settings.payments_coinpayments_guide_4' => 'Enter your Merchant ID & IPN Secret below.',
