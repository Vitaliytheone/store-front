...
return [
    ...
    'settings.payments_method_coinpayments' => 'Coin Payments',
    ...
    'settings.payments_edit_coinpayments' => 'Edit Coin Payments',
    'settings.payments_coinpayments_public_key' => 'Public Key',
    'settings.payments_coinpayments_private_key' => 'Private Key',
    'settings.payments_coinpayments_guide_1' => 'Sign up at {coinpayments_signup_url}.',
    'settings.payments_coinpayments_guide_2' => 'Create new API key pair at {coinpayments_api_settings_url}.',
    'settings.payments_coinpayments_guide_3' => 'Check permissions for your keys uses «Edit permissions» button opposite the generated key pair. The following permissions must be active:',
    'settings.payments_coinpayments_guide_3_1' => 'get_basic_info',
    'settings.payments_coinpayments_guide_3_2' => 'create_transaction',
    'settings.payments_coinpayments_guide_4' => 'Save key pair settings by click on «Update permissions» button.',
    'settings.payments_coinpayments_guide_5' => 'Enter your API Public Key and Private Key below.',
