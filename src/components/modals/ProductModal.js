            ...
            <div className="card-body">
              <div className="row seo-header align-items-center">
                ...
                <div className="col-sm-4 text-sm-right">
                  <div className="m-dropdown m-dropdown--inline m-dropdown--large m-dropdown--arrow m-dropdown--align-left" data-dropdown-toggle="hover" aria-expanded="true">
                    <a className="btn btn-sm btn-link m-dropdown__toggle" href="#">
                      ...
                      <div className="m-dropdown__inner">
                        <div className="m-dropdown__body">
                          <div className="m-dropdown__content dd-properties__max-height">
                            <div className="m--font-primary dd-properties__alert" role="alert">
              ...
              <div className="form-group">
                <div className="input-group">
                  ...
                  <span className="input-group-btn">
                    <button className="btn btn-primary add-properies" type="button">
                      Add
                    </button>
                  </span>
                </div>
                    ...
                    <div className="dd-handle">
                      <div className="dd-handle__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                          ...
                          <path d="M7 2c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm0 6c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm0 6c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm6-8c1.104 0 2-.896 2-2s-.896-2-2-2-2 .896-2 2 .896 2 2 2zm0 2c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm0 6c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2z" fill="#c6cad4" />
                        </svg>
                      </div>
                      Est.Delivery Time: 6-12 hrs
                    </div>
                    <div className="dd-edit-button">
                      <a href="#" className="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
            ...
            <div className="card-body">
              ...
              <div className="seo-preview">
                ...
                <div className="seo-preview__description edit-seo__meta">
                  ...
                  your business, the more confident people wil...
                </div>
              </div>
              ...
              <div className="collapse" id="seo-block">
                <div className="form-group">
                  ...
                  <input className="form-control" id="edit-seo__title" value="Product" />
                  <small className="form-text text-muted">
                    <span className="edit-seo__title-muted" /> of 70 characters used
                  </small>
                </div>
                <div className="form-group">
                  <label for="edit-seo__meta">Meta description</label>
                  <textarea className="form-control" id="edit-seo__meta" rows="3">
                    A great About Us page helps builds trust between you and your customers. The more content you provide about you and your business, the more confident people will text
                  </textarea>
                  <small className="form-text text-muted">
                    <span className="edit-seo__meta-muted" /> of 160 characters used
                  </small>
                </div>
                <div className="form-group">
                  <label for="edit-seo__meta-keyword">Meta keywords</label>
                  <textarea className="form-control" id="edit-seo__meta-keyword" rows="3" />
                </div>
                <div className="form-group">
                  ...
                  <div className="input-group">
                    ...
                    <input type="text" className="form-control" id="edit-seo__url" value="about-us" />
                  </div>
                </div>
              </div>
            </div>
