...
const ProductList = SortableContainer(({ data, response, handlePackageSwitch, onPackageAdd, handleEditProduct, handleEditPackage, handleDeletePackage, handleGetEditPackage, handleGetEditProduct }) => (
