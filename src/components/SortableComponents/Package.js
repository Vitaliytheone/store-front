...
const SortablePackage = SortableElement(({ pack, response, editPackage, deletePackage, getPackage }) => {
	return (
		<div className="group-item sommerce_dragtable__tr align-items-center">
			...
			<Col lg="1" className="padding-null-lg-right text-lg-right text-sm-left">
				<EditPackage response={response} onSubmit={editPackage} getPackage={getPackage} />
